                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="admin-profile.php"><i class="fa fa- user"></i>Profil</a>

                            <a class="nav-link" href="change-password.php"><i class="fa fa -cog"></i>Şifre Değiştir</a>

                            <a class="nav-link" href="index.php"><i class="fa fa-power -off"></i>Çıkış Yap</a>
                        </div>
                    </div>
