...
if (strlen($_SESSION['vpmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query) {
      echo "<script>alert('Kategori Bilgileri güncellendi');</script>";
    } else {
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <strong>Kategori </strong> Güncelle
            </div>
            <div class="card-body card-block">
              <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-12 col-md-9"><input type="text" id="catename" name="catename" class="form-control" placeholder="Araç Kategorisi" required="true" value="<?php echo $row['VehicleCat']; ?>"></div>
                </div>
                <?php } ?>
