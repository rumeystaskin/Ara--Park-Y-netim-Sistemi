        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <strong class="card-title">Kategori Yönetimi</strong>
            </div>
            <div class="card-body">
              <table class="table">
                <thead>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit-category.php?editid=<?php echo $row['ID']; ?>" class="btn btn-primary">Düzenle</a>
                        <a href="manage-category.php?del=<?php echo $row['ID']; ?>" class="btn btn-danger" onClick="return confirm('Silmek istediğinize emin misiniz?')">Sil</a>
                      </td>
                    </tr>
                  <?php
                    $cnt = $cnt + 1;
