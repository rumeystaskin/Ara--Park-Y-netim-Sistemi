...
<head>
    ...
    function checkpass() {
        if (document.changepassword.newpassword.value != document.changepassword.confirmpassword.value) {
            alert('Yeni Şifre ve Şifreyi Onayla alanı eşleşmiyor');
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                       <h2 style="color: green">Araç Park Yönetim Sistemi</h2>
                    </a>
                </div>
                <div class="login-form">
                    <form action="" method="post" name="changepassword" onsubmit="return checkpass();">
                        ...
                        <button type="submit" name="submit" class="btn btn-success btn-flat m-b-30 m-t-30">Sıfırla</button>
                    </form>
                </div>
            </div>
        </div>
