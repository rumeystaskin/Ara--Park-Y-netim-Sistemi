                ...
                <div class="login-form">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label>E-Posta Veya Numara</label>
                           <input type="text" name="emailcont" required="true" placeholder="E-Posta Veya Numara" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Parola</label>
                            <input type="password" name="password" placeholder="Parola" required="true" class="form-control">
                        </div>
                        <div class="checkbox">
                        ...
                        <button type="submit" name="login" class="btn btn-success btn-flat m-b-30 m-t-30">Giriş Yap</button>
